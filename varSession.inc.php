...
$reponse=$connexion->query("SELECT*FROM produits WHERE categorie='the_vert'");
while($donnees=$reponse -> fetch()){
    ...
    $truc='the_vert';
    $machin='Thé Vert';//$art->categorie;
    array_push($_SESSION['the_vert'],strval($truc),strval($machin));
    $reponse->closeCursor();


    $reponse=$connexion->query("SELECT*FROM produits WHERE categorie='the_noir'");
while($donnees=$reponse-> fetch()){
    $image=$donnees['URL'];
    $nom=$donnees['nom'];
    $ref=$donnees['reference'];
    ...
    $truc='the_noir';
    $machin='Thé noir';//$art->categorie;
    array_push($_SESSION['the_noir'],strval($truc),strval($machin));
    $reponse->closeCursor();

    $reponse=$connexion->query("SELECT*FROM produits WHERE categorie='infusion'");
while($donnees=$reponse -> fetch()){
    $image=$donnees['URL'];
    $nom=$donnees['nom'];
    $ref=$donnees['reference'];
